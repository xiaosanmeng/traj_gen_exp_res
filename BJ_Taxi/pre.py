...
if __name__ == '__main__':
    ...
    all_traj = pd.read_csv('../../traj_gen_exp_bj/data/BJ_Taxi/raw-data/BJ_Taxi_201511_trajectory.csv')
    with open('../../traj_gen_exp_bj/data/BJ_Taxi/cleaned-data/need_removed.pkl', 'rb') as file:
        need_removed = pickle.load(file)
    with open('../../traj_gen_exp_bj/data/BJ_Taxi/cleaned-data/oldrid2newrid.pkl', 'rb') as file:
